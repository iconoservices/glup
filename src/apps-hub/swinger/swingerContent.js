...
export const ROMPEHIELOS = [
  ...
  '{n}, cuenta qué es lo que más te llama la atención de este ambiente.',
  '{n}, dile un cumplido sincero a la pareja de {o}.',
  '{n} y {o}, cuenten qué fantasía les gustaría cumplir juntos en una noche como esta.',
  '{n}, cuéntale a {o} cuál es tu mayor punto débil cuando te seducen.',
...
export const PROMPTS = {
  picante: {
    verdad: [
      ...
      '{n}, ¿cuál ha sido tu experiencia más intensa o atrevida hasta hoy?',
      '{n}, ¿qué te da más celos y cómo lo manejas?',
      '{n}, ¿a quién del grupo invitarías a un trago a solas?',
